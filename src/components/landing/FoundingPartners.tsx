...
const copy = {
  ...
  vi: {
    badge: "Đội vào vòng 2 · Dự án Modu's Startup",
    title: "Cùng KONEXA bắt đầu dự án đầu tiên.",
    lead: "Hãy chia sẻ công việc doanh nghiệp cần thực hiện. Chúng tôi cùng bạn xác định phạm vi và kết quả bàn giao từng tuần, rồi kết nối ứng viên phù hợp có thể tham gia.",
    company: "Bắt đầu từ nhu cầu thực tế của doanh nghiệp.",
    companyBody: "Đăng yêu cầu về nghiên cứu thị trường, nội dung, thiết kế, lập trình hoặc công việc theo dự án khác. KONEXA hỗ trợ làm rõ yêu cầu thành một dự án cụ thể.",
    companyCta: "Tạo tài khoản doanh nghiệp và đăng dự án",
    talent: "Bắt đầu với khoảng 10 sinh viên.",
    talentBody: "Chúng tôi dự kiến tuyển khoảng 10 sinh viên cho các dự án đầu tiên, sau đó mở rộng theo nhu cầu doanh nghiệp và kinh nghiệm vận hành.",
    talentCta: "Tham gia với vai trò ứng viên",
    steps: ["Xác định phạm vi", "Đặt kết quả từng tuần", "Kết nối ứng viên có thể tham gia"],
    notice: "Hiện chúng tôi tiếp nhận đối tác ban đầu qua đăng ký tài khoản, hồ sơ và tin dự án. Thanh toán, ký quỹ và chữ ký điện tử sẽ được thông báo sau khi hoàn tất tích hợp và các điều kiện vận hành.",
    closed: "Đã ngừng nhận đăng ký mới cho ưu đãi kết thúc ngày 5/8. Quyền lợi đã được xác nhận được quản lý theo điều khoản đã thống nhất.",
  },
} as const;

export default function FoundingPartners({ locale, onCompany, onStudent }: { locale: Locale; onCompany: () => void; onStudent: () => void }) {
  const t = copy[locale];
