...
const copy = {
  ...
  vi: {
    ...
    badge: "Dự án thực tế. Hiểu rõ năng lực.",
    ...
    lead: "Một dự án thực tế cho thấy năng lực rõ hơn một bản CV. KONEXA cùng doanh nghiệp xác định phạm vi công việc và kết quả từng tuần, sau đó kết nối ứng viên quốc tế có thể tham gia.",
    studentCta: "Tạo hồ sơ ứng viên", companyCta: "Đăng tin tuyển dụng",
    note: "Đang tiếp nhận doanh nghiệp đối tác và sinh viên cho giai đoạn đầu. Thanh toán, ký quỹ và chữ ký điện tử sẽ được thông báo khi sẵn sàng.",
    ledger: "HỒ SƠ DỰ ÁN · XEM TRƯỚC", live: "MINH HỌA", relationship: "QUAN HỆ HỢP TÁC", candidate: "Nhà thiết kế sản phẩm quốc tế",
    ...
    modules: [
      ...
      ["03", "Bảo vệ thanh toán khi sẵn sàng", "Chúng tôi đang chuẩn bị tích hợp thanh toán và ký quỹ tại Hàn Quốc. Bảo vệ thanh toán chưa được cung cấp trước khi hoàn tất các điều kiện vận hành."],
    ...
    reviewLead: "Tính năng đánh giá dành cho người tham gia dự án trả phí đã xác thực; hai nhận xét được công bố sau khi cả hai gửi đánh giá. Các thẻ dưới đây chỉ là minh họa, không phải phản hồi thực tế.",
    companyReviewLabel: "ĐÁNH GIÁ TỪ DOANH NGHIỆP · MINH HỌA", talentReviewLabel: "ĐÁNH GIÁ TỪ ỨNG VIÊN · MINH HỌA",
    companyReview: "Kết quả vượt mong đợi và quá trình trao đổi luôn suôn sẻ.", studentReview: "Phạm vi công việc rất rõ ràng và tôi luôn nhận được phản hồi kịp thời.", sealed: "Giữ kín đến khi bên còn lại hoàn tất", revealed: "Công bố cùng lúc khi cả hai bên hoàn tất",
    ...
    ctaTitle: "Bắt đầu dự án tiếp theo cùng KONEXA.", ctaLead: "Tạo tài khoản doanh nghiệp và đăng công việc bạn cần. Nếu có câu hỏi trước khi bắt đầu, hãy gửi email cho chúng tôi.", contact: "Gửi email cho KONEXA",
