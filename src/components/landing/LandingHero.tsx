...
const copy = {
  ...
  en: {
    ...
    lead: "KONEXA lets Korean companies and global talent work together on a real project before they commit to hiring. Contracts, payments, and reviews become verified proof of experience.",
  ...
  vi: {
    ...
    lead: "KONEXA giúp doanh nghiệp Hàn Quốc và nhân tài quốc tế cùng làm một dự án thực tế trước khi tuyển dụng. Hợp đồng, thanh toán và đánh giá được lưu lại thành minh chứng kinh nghiệm đã xác thực.",
