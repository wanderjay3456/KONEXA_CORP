...
export default function EarlyBirdCampaign({ locale, onStudent, onCompany }: EarlyBirdCampaignProps) {
    if (!isEarlyBirdOpen())
        return <FoundingPartners locale={locale} onStudent={onStudent} onCompany={onCompany}/>;
    const t = campaignCopy[locale];
    return (<section id="early-bird" className="bg-[#f7f6f1] px-5 py-24 sm:px-8 lg:py-32">
