...
const copy = {
  ...
  vi: {
    eyebrow: "Tạo tài khoản doanh nghiệp trong 1 phút",
    title: "Tạo tài khoản trước, rồi bổ sung thông tin tuyển dụng sau khi đăng nhập.",
    lead: "Ở bước này, KONEXA chỉ yêu cầu tên doanh nghiệp và thông tin đăng nhập. Giấy tờ, liên hệ và nhu cầu tuyển dụng sẽ được hướng dẫn trong hồ sơ doanh nghiệp.",
    ...
    companyPlaceholder: "Nhập tên pháp lý hoặc tên giao dịch",
    ...
    required: "Kiểm tra tên doanh nghiệp, email, mật khẩu từ 8 ký tự và các đồng ý bắt buộc.",
    confirmationTitle: "Hãy kiểm tra email.",
    confirmationBody: "Xác nhận email rồi đăng nhập. Bạn sẽ được chuyển thẳng đến phần hồ sơ doanh nghiệp bắt buộc.",
    login: "Đi đến đăng nhập",
    back: "Quay lại",
    next: "Tiếp theo là phần xác minh doanh nghiệp bắt buộc.",
    safety: "Hồ sơ doanh nghiệp chưa hoàn thiện không thể đăng cơ hội; hệ thống sẽ hướng dẫn từng thông tin và giấy tờ bắt buộc.",
  },
} as const;
